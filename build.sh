#!/bin/bash
patch -Np1 -i "${SHED_PATCHDIR}/openssh-7.6p1-openssl-1.1.0-1.patch" && \
...
install -v -dm755 "${SHED_FAKEROOT}/usr/share/doc/openssh-7.6p1"
install -v -m644 INSTALL LICENCE OVERVIEW README* "${SHED_FAKEROOT}/usr/share/doc/openssh-7.6p1"
